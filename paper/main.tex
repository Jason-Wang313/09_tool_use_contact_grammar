...
\begin{document}
\maketitle
\noindent\textbf{Submission-hardening v2, 2026-06-12.} Added a perception-noise stress test that corrupts the symbolic predicates observed by the grammar while scoring against the unchanged mechanical oracle.
